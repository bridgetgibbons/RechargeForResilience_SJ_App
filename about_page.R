...
project <- HTML('<div style="height: 90vh; overflow: auto" class="jumbotron">
  ...
  <p style="text-align: justify;" class="lead">This website explores the results of a decision support tool for assessing site suitability for multiple benefit groundwater recharge projects in California’s San Joaquin Valley. Sites are identified as relatively suitable or unsuitable based on the following: an assessment of surface and subsurface characteristics, such as depth to groundwater, the presence or absence of confining layers, and soil coarseness; an assessment of nitrogen loading at the ground surface, largely a result of historical land use. Suitable areas are better able to allow for water to move from the surface into aquifer storage without degrading water quality. </p>
